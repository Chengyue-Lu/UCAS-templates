...
本项目收集并整理了适用于中国科学院大学（UCAS）学生的各类 LaTeX 模板，涵盖课程论文、实验报告、课堂笔记、课后作业以及 Beamer 演示文稿等场景。

## 📂 模板列表

### 1. 课程论文模板 (`For 课程论文`)

功能最全面的课程论文模板，支持高度自定义配置。
...
基于 ElegantNote 的美观笔记模板，适合整理课程复习资料。
